...
export function PodPanel(): ReactElement {
  ...
  return createElement(
    ...
    createElement(
      'div',
      { style: styles.form },
      createElement('input', { style: styles.input, placeholder: 'mission 名称', value: name, onChange: (e) => setName(e.target.value) }),
      createElement('input', { style: styles.input, placeholder: '一句话可验收目标', value: goal, onChange: (e) => setGoal(e.target.value) }),
      createElement('input', { style: styles.input, placeholder: 'cwd（git 仓库绝对路径）', value: cwd, onChange: (e) => setCwd(e.target.value) }),
      createElement('input', { style: styles.input, placeholder: '预算 $', value: budget, onChange: (e) => setBudget(e.target.value) }),
      createElement('input', {
        style: styles.input,
